  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
      <div className="bg-gray-800 border border-gray-600 rounded-xl p-6 w-full max-w-md">
        <h2 className="text-xl font-bold mb-6 text-center">Enter Score</h2>

        <div className="space-y-4">
          <div className="flex items-center gap-4">
            <label className="flex-1 text-right font-medium">{team1Name}</label>
            <input
              type="number"
              min="0"
              value={team1Score}
              onChange={(e) => setTeam1Score(e.target.value)}
              className="w-20 bg-gray-700 border border-gray-600 rounded-lg px-3 py-2 text-center text-lg font-bold text-white focus:border-blue-500 focus:outline-none"
              autoFocus
            />
          </div>
          ...
          <div className="flex items-center gap-4">
            <label className="flex-1 text-right font-medium">{team2Name}</label>
            <input
              type="number"
              min="0"
              value={team2Score}
